...
import { Workflow, Rocket, Briefcase, ArrowRight } from 'lucide-react';
...
const BuildAISection = () => {
  ...
  const features = [
    ...
    { icon: Briefcase, text: 'Career-aligned tracks' },
  ];
  ...
  return (
    <section
      ref={sectionRef}
      id="build-ai"
      className="relative min-h-screen lg:h-screen bg-mirai-navy z-40 overflow-hidden py-16 lg:py-0"
    >
      {/* Gradient orb */}
      <div
        ref={orbRef}
        className="gradient-orb w-[70vw] h-[70vw] bg-mirai-coral/18"
        style={{ top: '5%', right: '-15%', opacity: 0.3 }}
      />

      <div className="relative w-full min-h-screen flex flex-col lg:flex-row items-center justify-center px-6 lg:px-0">
        {/* Portrait Card - Left side (Mobile: top, Desktop: left) */}
        <div
          ref={imageRef}
        ...
        >
          <img
            src="/build_adult_glasses.jpg"
            alt="Asian young adult building AI"
            className="w-full h-full object-cover"
          />
        </div>

        {/* Content Block - Right side (Mobile: below, Desktop: right) */}
        <div
          ref={contentRef}
        ...
        >
          ...
          <div ref={bodyRef}>
            <p className="text-mirai-gray text-sm lg:text-lg leading-relaxed mb-6 lg:mb-8 max-w-lg mx-auto lg:mx-0">
              Career-ready AI capability, productivity, and competitive advantage. Build real workflows, ship projects, and stand out in the market.
            </p>
